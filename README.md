...
to tickets. The compose file has two of them (`simulator-a` and
`simulator-b`), so you can play both sides of a conversation:
`docker compose --profile simulator up -d`, see
[`simulator/README.md`](simulator/README.md).
